...
public class Customer {
   ...
   // private double recency;
    ...
    public double calculateFrequency(int orderIndex) {   //by using days  //error:returns infinities
        ...
        if (orderIndex>0) {
            ...
            double frequency = ( ((orderIndexDouble + 1.0) * 1000000 ) / (Duration.between(firstOrder, lastOrder).toMillis()));//toavoid infinity
            return frequency;
